...
describe('EasyLocation', function() {
  ...
  describe('util#getPathValues', function() {
    ...
    it('should return correct array', function() {
      var dom = new JSDOM('', {
        url:
          'https://example.com/english/%D1%80%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9/%E6%97%A5%E6%9C%AC%E8%AA%9E/'
      });

      global.window = dom.window;

      expect(util.getPathValues()).to.be.eql(['english', 'русский', '日本語']);
    });
  });
  ...
  describe('util#getSearchValues', function() {
    ...
    it('should return correct object', function() {
      var dom = new JSDOM('', {
        url:
          'https://example.com/?a=1&lang=%D1%80%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9&%E6%97%A5%E6%9C%AC%E8%AA%9E=false'
      });
  ...
  describe('util#preparePath', function() {
    ...
    it('should return correct path', function() {
      expect(util.preparePath(['english', 'русский', '日本語'])).to.be.eql(
